...
import com.javafx.games.algebra.Math;
...
class Plateau extends GameObject
{
    ...
    private static final String
            PLATEAU_1_IMAGE_PATH =  "images/plateau_1.png",
            PLATEAU_2_IMAGE_PATH =  "images/plateau_2.png";
    ...
    {           
        ...
        this.view =   new Rectangle(0, 0, this.stretchingFactor * PLATEAU_WIDTH, PLATEAU_HIGHT);
        ...
        ImagePattern imagePattern = new ImagePattern(
                new Image(fromUrlOf(random_plateau_image())), 0, 0, this.view.getWidth(), PLATEAU_HIGHT, false);
